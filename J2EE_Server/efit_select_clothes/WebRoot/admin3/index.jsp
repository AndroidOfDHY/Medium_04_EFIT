...
<script src="<%=path %>/admin/js/speedup.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/jquery-1.7.1.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/jquery.cookie.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/jquery.validate.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/jquery.bgiframe.js" type="text/javascript"></script>
<script src="<%=path %>/admin/xheditor/xheditor-1.1.12-zh-cn.min.js" type="text/javascript"></script>
<script src="<%=path %>/admin/uploadify/scripts/swfobject.js" type="text/javascript"></script>
<script src="<%=path %>/admin/uploadify/scripts/jquery.uploadify.v2.1.0.js" type="text/javascript"></script>

<script src="<%=path %>/admin/js/dwz.core.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.util.date.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.validate.method.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.regional.zh.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.barDrag.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.drag.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.tree.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.accordion.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.ui.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.theme.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.switchEnv.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.alertMsg.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.contextmenu.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.navTab.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.tab.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.resize.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.dialog.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.dialogDrag.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.sortDrag.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.cssTable.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.stable.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.taskBar.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.ajax.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.pagination.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.database.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.datepicker.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.effects.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.panel.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.checkbox.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.history.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.combox.js" type="text/javascript"></script>
<script src="<%=path %>/admin/js/dwz.print.js" type="text/javascript"></script>
<!--
						...
						<ul class="tree treeFolder">
							...
							<li><a>常用组件</a>
								<ul>
									...
									<li><a href="admin/clothes.do" target="navTab" rel="w_table">表格数据库排序+批量删除</a></li>
