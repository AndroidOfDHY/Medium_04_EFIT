...
%>
 <%
                         User user=null;
                         user=(User)session.getAttribute(Globals.USER_SESSION_KEY);
                         %>
		...
		<div id="main_container">
			...
			<div id="main_content">
				...
				<div id="center_content">
					...
					<div class="title">
						<a href="index.html">主页</a> &lt;&lt; 推荐
					</div>

							<s:if test="#request.matchList==null">
							<div id="container"> <font size="20px" color="red">暂无推荐！</font></div>
						    </s:if>
						    <s:else>    
                     <!-- 轮显开始 -->
					<div id="container">
							...
							<div id="slides">
								<div class="slides_container">
									...
									<s:iterator value="#request.matchList" id="MatchClothes">
										<a href="#" onclick="<%if(user!=null){ %>
										wear('${MatchClothes.sex}','../clothes/${MatchClothes.tThumbAdress}','../clothes/${MatchClothes.tImageAdress}','${MatchClothes.tName}','../clothes/${MatchClothes.dThumbAdress}','../clothes/${MatchClothes.dImageAdress}','${MatchClothes.dName}','${MatchClothes.tId}','${MatchClothes.dId}')
										<%}else out.print("javascript:alert('试穿请登入');"); %>
										" title="E裳智换">
											<div class="product_box" style="margin-left:0px;  width:570px; height:270px;">
												<div>
													<img
														...
														<p><font color="red" style="font-size: 15px">${MatchClothes.tName}:</font>${MatchClothes.tDetail}</p>
														<p><font color="red" style="font-size: 15px">${MatchClothes.dName}:</font>${MatchClothes.dDetail}</p>
													</span>
												</div>
											</div> </a>
									</s:iterator>
