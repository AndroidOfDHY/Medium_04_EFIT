...
var checkbox = $('input[name="delid"]');
	...
	function(tp){
	if(tp=='ok'){
		$.post("<%=request.getContextPath()%>/admin/clothes.do", {"clothesIds": ids, "act": "delete"}, function(msg){
				if(msg == '200') {
        ...
        <tr>
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
               ...
               <td height="20"><span class="newfont07">选择：<a href="#" class="right-font08" onclick="selectAll();">全选</a>-<a href="#" class="right-font08" onclick="unselectAll();">反选</a></span>
		           <input name="Submit" type="button" class="right-button08" value="删除所选题目" onclick="deleteSelect()" /> 
		           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	              </td>
          </tr>
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="20" colspan="9" align="center" bgcolor="#EEEEEE"class="tablestyle_title"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 衣物列表 &nbsp;</td>
                    </tr>
                  <tr>
				    <td width="6%" align="center" bgcolor="#EEEEEE">选择</td>
					 <td width="9%" height="20" align="center" bgcolor="#EEEEEE">服装名称</td>
                    <td width="9%" align="center" bgcolor="#EEEEEE">类型</td>
                    <td width="9%" align="center" bgcolor="#EEEEEE">性别</td>
                    <td width="9%" align="center" bgcolor="#EEEEEE">尺寸</td>
					<td width="9%" align="center" bgcolor="#EEEEEE">缩略图</td>
					<td width="9%" align="center" bgcolor="#EEEEEE">匹配值</td>
					<td width="9%" align="center" bgcolor="#EEEEEE">提交时间</td>
                    <td width="19%" align="center" bgcolor="#EEEEEE">操作</td>
                  </tr>
                   <s:iterator value="#request.clothesList">
                  <tr>
				    <td  align="center" bgcolor="#FFFFFF"><input type="checkbox" name="delid" value="<s:property value='clothes.clothesId'/>"/></td>
                    <td align="center" bgcolor="#FFFFFF"><s:property value="clothes.clothesName" /></td>
                    <td align="center" bgcolor="#FFFFFF"><s:property value="clothes.type" /></td>
                    <td align="center" bgcolor="#FFFFFF"><s:property value="clothes.sex" /></td>
                    <td align="center" bgcolor="#FFFFFF"><s:property value="clothes.size" /></td>
                    <td align="center" bgcolor="#FFFFFF"><img src="<%=path %>/clothes/<s:property value="clothes.thumbAdress" />" width="100" height="100" onerror="this.src='<%=path %>/system/null.jpg'"/></td>
                    <td align="center" bgcolor="#FFFFFF"><s:property value="clothes.matchValue" /></td>
                    <td align="center" bgcolor="#FFFFFF"><s:property value="clothes.submitTime" /></td>
                    <td align="center" bgcolor="#FFFFFF"><a href="admin/clothes.do?act=detail&clothesId=<s:property value='clothes.clothesId'/>&page=modifyClothes">编辑</a>&nbsp;|&nbsp;<a href="admin/clothes.do?act=detail&clothesId=<s:property value='clothes.clothesId'/>&page=detailClothes">详情</a></td>
                  </tr>
                  </s:iterator>
                </table></td>
              </tr>
