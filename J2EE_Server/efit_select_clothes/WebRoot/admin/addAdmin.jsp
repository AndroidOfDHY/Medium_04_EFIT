...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >管理员添加</th>
  </tr>
  <tr>
    <td class="CPanel">
   ...
   <table border="0" cellpadding="2" cellspacing="1" align="center" width="50%">
		...
		<tr><td>账号：</td><td><input type="text" name="thumbAdress" id="thumbAdress" class="text"/></td></tr>
		<tr><td>输入密码：</td><td><input type="password" name="imageAdress" id="imageAdress" class="text"/></td></tr>	
		<tr><td>再次输入密码：</td><td><input type="password" name="brand" id="brand" class="text"></td></tr>    
	 </table>
	 </form>
			  <br />
				</fieldset>			</TD>
