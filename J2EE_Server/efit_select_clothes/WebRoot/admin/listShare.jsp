...
var checkbox = $('input[name="delid"]');
		...
		if(idsStr.length == 0) {
			ymPrompt.alert({title:'提示',message:'请选择要删除的题目!',autoClose:true});
			return ;
		}
		var ids = idsStr.join(",");
	...
	function(tp){
	if(tp=='ok'){
		$.post("<%=request.getContextPath()%>/admin/share.do", {"shareIds": ids, "act": "delete"}, function(msg){
				if(msg == '200') {
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="20" colspan="6" align="center" bgcolor="#EEEEEE"class="tablestyle_title"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 分享列表 &nbsp;</td>
                    </tr>
                  <tr>
				    <td width="6%" align="center" bgcolor="#EEEEEE">选择</td>
					 <td width="9%" height="20" align="center" bgcolor="#EEEEEE">用户</td>

                    <td width="9%" align="center" bgcolor="#EEEEEE">分享时间</td>
                    <td width="9%" align="center" bgcolor="#EEEEEE">上衣</td>
					<td width="9%" align="center" bgcolor="#EEEEEE">下衣</td>
                    <td width="19%" align="center" bgcolor="#EEEEEE">操作</td>
                  </tr>
                   <s:iterator value="#request.shareList" id="Share">
                  <tr>
				    <td  align="center" bgcolor="#FFFFFF"><input type="checkbox" name="delid" value="${Share.shareId}"/></td>
                    <td align="center" bgcolor="#FFFFFF">${Share.userName}</td>

                    <td align="center" bgcolor="#FFFFFF">${Share.shareTime}</td>

                    <td align="center" bgcolor="#FFFFFF">${Share.tName}</td>
                    <td align="center" bgcolor="#FFFFFF">${Share.dName}</td>
                    <td align="center" bgcolor="#FFFFFF"><a href="admin/clothes.do?act=detail&clothesId=<s:property value='clothesId'/>&page=detailClothes">详情</a></td>
                  </tr>
                  </s:iterator>
                </table></td>
              </tr>
