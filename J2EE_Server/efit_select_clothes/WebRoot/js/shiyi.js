function ss_xt2(){//自己加的
	document.getElementById("ss_xt").style.display="none";
	}
function scroll(n){
temp=n;
...
function ss_mendt(){
	...
	document.getElementById("ss_women").src="../syimages/rw_22.gif";
	document.getElementById("ss_men").src="../syimages/rw_1.gif";
...
function ss_womendt(){
	...
	document.getElementById("ss_men").src="../syimages/rw_11.gif";
	document.getElementById("ss_women").src="../syimages/rw_2.gif";
...
function deletebutton(){
	...
	document.getElementById("shiyi_"+i).src="../syimages/tm.gif";
